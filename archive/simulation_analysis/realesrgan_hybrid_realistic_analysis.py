...
class HybridArchitectureAnalyzer:
    ...
    def _generate_recommendations(self, results: List[Dict]) -> List[str]:
        ...
        if avg_latency < 20:
            ...
            recommendations.append("⚠️ High latency - consider resolution reduction or model optimization")
        ...
        if realtime_percent >= 70:
            ...
            recommendations.append("⚠️ Consider hardware upgrades or algorithm optimization")
