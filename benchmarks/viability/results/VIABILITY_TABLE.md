# Tabla de viabilidad: upscaling con IA en tiempo real
...
**Pruebas de carga:** degradación relativa respecto al reposo en la misma combinación.

---
## FSRCNN_x2.pb
_×2 → salida duplica resolución_

| Dispositivo | Entrada | Salida | FPS reposo | Lat ms | PSNR dB (SSIM) | Viabilidad | Bajo carga (FPS, Δ%) |
|--------|---------|--------|----------|--------|----------------|------------|-----------------|
